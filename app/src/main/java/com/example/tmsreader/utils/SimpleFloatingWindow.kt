...
/*import kotlinx.android.synthetic.main.layout_floating_window.*
...
class SimpleFloatingWindow constructor(private val context: Context) {
    ...
    private var floatView: View =
        LayoutInflater.from(context).inflate(R.layout.floating_layout, null)
    ...
    init {
        ...
        readInPageClass = ReadInPageClass()
        with(floatView) {
            closeImageButton.setOnClickListener{
                dismiss()
                readInPageClass.pausePlayTTS(!pausePlay)
